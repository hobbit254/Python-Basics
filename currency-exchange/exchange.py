...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Calculate the effective exchange rate with the spread added
    effective_rate = exchange_rate * (1 + spread_decimal)

    # Convert the budget using the effective exchange rate
    exchanged_amount = budget / effective_rate

    # Determine how many whole units of the new currency can be obtained
